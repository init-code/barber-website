...
A sua privacidade é importante para nós. É política do Prime Calendar respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no aplicativo Prime Calendar, e outros aplicativos que possuímos e operamos.
...
O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Prime Calendar oferece no aplicativo e com caráter enunciativo, mas não limitativo:
...
C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Prime Calendar, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.

## Mais informações

Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.

Esta política é efetiva a partir de 18 January 2023 00:43